...
export default function PagesExamplesTailwindLayout({
  children,
  title = 'TS-CC 页面',
 ...
 * ```
 */
export function withPagesExamplesTailwindLayoutLayout (
  ...
  const WrappedComponent = (props: any) => {
    return (
      <PagesExamplesTailwindLayout {...layoutProps}>
        <Component {...props} />
      </PagesExamplesTailwindLayout>
    )
  }

  // 保持组件名称用于调试
  WrappedComponent.displayName = `withPagesExamplesTailwindLayout(${Component.displayName ||
  Component.name})`
