  ...
  useEffect(() => {
    return combine(
      ...
      dropTargetForElements({
        ...
        getData({ input }) {
          // 拖动时调用，返回内容 top / bottom 保存到 target.data
  ...
  */
  ...
  return (
    <div
      ...
      ref={useMergeRefs([virtualizer.measureElement, containerRef])}
    ...
    >
      ...
      <div ref={draggerRef} className="cursor-grab active:cursor-grabbing text-gray-400 hover:text-gray-600 pr-2" /* 防止图标自身被拖动（让整个 item 控制拖拽）*/ draggable={false}>
        <TbGripVertical className="text-md" />
      </div>
      <WordContent word={word} />
