...
/** @lends Kekule.Render.CanvasRendererBridge# */
{
	...
	{
		// temp, draw a normal rect than a round rect
	...
	drawPath: function(ctx, path, options)
	{
		...
		for (var i = 0, l = path.length; i < l; ++i)
		{
			...
			var method;
			// currently S, T and A are not implemented
			if (index >= 0)
			{
...
Kekule.Render.DrawBridge2DMananger.register(Kekule.Render.CanvasRendererBridge, 10);
