...
(function ($jsRoot) {
    ...
    addMethods: function (source) {
      ...
      for (var i = 0, length = properties.length; i < length; i++) {
        ...
        if (ancestor && isFunction && FunctionUtils.argumentNames(value).first() == '$super') {
          ...
          value = (function (m) {
            return function () {
              return (ancestor[m] || doNothing).apply(this, arguments);
            };
  ...
  Object._extendSupportMethods(String.prototype, {
    ...
    pad: function (length, padString, rightPad) {
      var p = padString || ' ';
      var a = [];
      for (var i = 0, l = length - this.length; i < l; ++i) { a.push(p); }
      var str = this;
      if (rightPad) {
        return str + a.join('');
      } else {
  ...
  var StringUtils = {
    ...
    deserializeValue: function (str, preferedType) {
      ...
      switch (str) {
        case StringUtils.STRUE:
          return true;
          break;
        case StringUtils.SFALSE:
          return false;
          break;
        case StringUtils.SNULL:
          return null;
          break;
        case StringUtils.SUNDEFINED:
          return undefined;
          break;
        case StringUtils.SNAN:
          return NaN;
          break;
        default: {
          if (preferedType) {
  ...
  Class.EventHandlerList.prototype = {
     ...
     */
    removeAt: function (index) {
      for (var i = index, l = this.handlers.length; i < l; ++i) { this.handlers[i] = this.handlers[i + 1]; }
  ...
  var DataType = {
    ...
    getType: function (value) {
      ...
      switch (stype) {
        // Some native classes such as RegExp are not checked yet
        // basic types
        case 'undefined':
      ...
      for (var i = 0, length = properties.length; i < length; i++) {
        ...
        if (typeof (value) == 'function') {
          ...
          if (first == '$super') {
            ...
            value = (function (m) {
              return function () {
                return ancestor[m].apply(/* proto */this, arguments);
              };
            })(property).wrap(method);
            value.valueOf = method.valueOf.bind(method);
            value.toString = method.toString.bind(method);
      ...
      /** @lends ObjectEx# */
      {
        ...
        endUpdate: function () {
          ...
          if (!this.isUpdating())  // update end, notify changed properties
          {
            ...
            }  // special propName, indicating children has been changed
