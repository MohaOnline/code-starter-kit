...
/** @lends Kekule.ChemWidget.ChemObjDisplayer# */
{
	...
	*/
	...
	{
		// Currently autosize is not enabled in 3D mode
...
/**
 * Action for zoom in the viewer.界面放大缩小
 * @class
...
/** @lends Kekule.ChemWidget.ActionDisplayerZoomOut# */
{
	...
	/** @private */
	doExecute: function(s,event)
	{
		this.getDisplayer().zoomCustom(event.customRadio);
	}
});
/**
