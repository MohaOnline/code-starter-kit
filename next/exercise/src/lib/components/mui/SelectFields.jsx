...
export function SelectFieldSingle({
  ...
  return (
    <FormControl sx={{m: 1, minWidth: 180,}} size="small">
      ...
      <Select value={selected ?? ''} renderValue={_ => (items.find((item) => item.value === selected)?.label)} onChange={handleChange}
              sx={{
              ...
              endAdornment={
                selected && (<InputAdornment position="end" sx={{marginRight: 0.5, marginLeft: 0}}>
