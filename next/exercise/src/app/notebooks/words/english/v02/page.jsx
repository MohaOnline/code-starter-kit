...
import {FaEdit, FaPlay, FaPause, FaTrash, FaVolumeUp, FaSync, FaSearch, FaSort} from "react-icons/fa";
...
export default function Page() {
  ...
  // 排序完成回调
  const handleSortComplete = (newWords) => {
    setStatus(prev => ({
      ...prev,
      words: newWords,
    }));
  ...
  return (
    <>
      ...
      <div className={"operation text-center"}>
        ...
        <button
          onClick={() => {
            setStatus(prev => ({...prev, isSortDialogOpen: true}));
          }}
      ...
      {/* 排序对话框 */}
      <SortDialog
        isOpen={status.isSortDialogOpen}
        onClose={() => setStatus(prev => ({ ...prev, isSortDialogOpen: false }))}
        words={status.words}
