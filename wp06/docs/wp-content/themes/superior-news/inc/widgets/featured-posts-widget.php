<?php
if ( ! class_exists( 'Random_News_Featured_Posts_Widget' ) ) {
	/**
	 * Adds Random News Featured Posts Widget.
	 */
	class Random_News_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$featured_posts_widget = array(
				...
				'description' => __( 'Retrive Featured Posts Widgets', 'superior-news' ),
			);
			parent::__construct(
				'random_news_featured_posts_widget',
				__( 'Random News: Featured Posts Widget', 'superior-news' ),
