<?php
if ( ! class_exists( 'Random_News_Most_Read_Widget' ) ) {
	/**
	 * Adds Random News Most Read Widget.
	 */
	class Random_News_Most_Read_Widget extends WP_Widget {
		...
		public function __construct() {
			$most_read_widget = array(
				...
				'description' => __( 'Retrive Most Read Widgets', 'random-news' ),
			);
			parent::__construct(
				'random_news_most_read_widget',
				__( 'Random News: Most Read Widget', 'random-news' ),
				$most_read_widget
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show( Min:1 | Max:8 ):', 'random-news' ); ?></label>
