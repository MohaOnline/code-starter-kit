<?php
if ( ! class_exists( 'Random_News_Express_List_Widget' ) ) {
	/**
	 * Adds Random News Express List Widget.
	 */
	class Random_News_Express_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$express_list_widget = array(
				...
				'description' => __( 'Retrive Express List Widgets', 'random-news' ),
			);
			parent::__construct(
				'random_news_express_list_widget',
				__( 'Random News: Express List Widget', 'random-news' ),
				$express_list_widget
			);
		}
