 ...
 * Custom Style
 */
function random_news_header_text_style() {

	$site_title_font       = get_theme_mod( 'random_news_site_title_font', '' );
	$site_description_font = get_theme_mod( 'random_news_site_description_font', '' );
	$header_font           = get_theme_mod( 'random_news_header_font', '' );
	$body_font             = get_theme_mod( 'random_news_body_font', '' );
	...
	<style type="text/css">
		...
		.site-description {
			color: <?php echo esc_attr( get_theme_mod( 'random_news_header_tagline', '#404040' ) ); ?>;
		}
...
add_action( 'wp_head', 'random_news_header_text_style' );
