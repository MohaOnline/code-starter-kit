...
<?php }?>
:root{
--tsvg_p_lm_bc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_24), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_c_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_25), FILTER_SANITIZE_STRING);?>;
...
--tsvg_p_lm_cbc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_26), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_cc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_27), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hbc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_28), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm_hc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_29), FILTER_SANITIZE_STRING);?>;
--tsvg_p_lm__bdc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_30), FILTER_SANITIZE_STRING);?>;
}
...
<script>
    ...
    function tsvgPaginationGenerate<?php echo esc_attr( $tsvg_js_shortcode_id ); ?>(id = "<?php echo esc_attr( $tsvg_shortcode_id ); ?>") {
        ...
        // var next_text = '';
        // var prev_text =''; 
        // var next_icon ='<?php echo esc_js($tsvg_style_options->TotalSoft_GV_2_39);?>'; 
        // var prev_icon ='<?php echo esc_js($tsvg_style_options->TotalSoft_GV_2_38);?>'; 
        // var load_icon ='<?php echo esc_js($tsvg_style_options->TotalSoft_GV_2_32);?>'; 
