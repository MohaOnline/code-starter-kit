<style type="text/css">
    ...
    <?php }?>
    :root{
    --tsvg_p_lm_bc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_1_39), FILTER_SANITIZE_STRING);?>;
    --tsvg_p_lm_c_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_01), FILTER_SANITIZE_STRING);?>;
    ...
    --tsvg_p_lm_ff_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_03), FILTER_SANITIZE_STRING);?>;
    --tsvg_p_lm_cbc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_04), FILTER_SANITIZE_STRING);?>;
    --tsvg_p_lm_cc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_05), FILTER_SANITIZE_STRING);?>;
    --tsvg_p_lm_hbc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_06), FILTER_SANITIZE_STRING);?>;
    --tsvg_p_lm_hc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_07), FILTER_SANITIZE_STRING);?>;
    --tsvg_p_lm_bs_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_08), FILTER_SANITIZE_STRING);?>;
    --tsvg_p_lm__bdc_<?php echo esc_attr($tsvg_shortcode_id);?>:<?php echo filter_var(esc_html($tsvg_style_options->TotalSoft_GV_2_09), FILTER_SANITIZE_STRING);?>;
    }
...
<script>
    ...
    function tsvgPaginationGenerate<?php echo esc_attr( $tsvg_js_shortcode_id ); ?>(id = "<?php echo esc_attr( $tsvg_shortcode_id ); ?>") {
        ...
        var showTo;
        var pageNumber = 1;
        // var next_text = '<?php echo esc_js($tsvg_style_options->TotalSoft_GV_1_37);?>';
        // var prev_text ='<?php echo esc_js($tsvg_style_options->TotalSoft_GV_1_38);?>'; 
        // var next_icon =''; 
        // var prev_icon =''; 
        // var load_icon =''; 
