<style type="text/css">
	:root{
  	...
  	<?php if ( $ts_vgallery_edit == 'true' ) { ?>
		.TS_VGallery_slideshow<?php echo esc_attr( $Total_Soft_vgallery ); ?>[data-popup-content='builder-show'] ,.TS_VGallery_slideshow<?php echo esc_attr( $Total_Soft_vgallery ); ?>[data-popup-content='builder-show'] .TS_VGallery_item,
        .TS_VGallery_slideshow<?php echo esc_attr( $Total_Soft_vgallery ); ?>[data-popup-content='builder-show'] .TS_VGallery_item >figure,
    ...
    .TS_VGallery_nav-close-RW<?php echo esc_attr( $Total_Soft_vgallery ); ?>{
		padding:0;
	}
    ...
    @media only screen and (max-width: 650px) {
        ...
        .TS_VGallery_slideshow<?php echo esc_attr( $Total_Soft_vgallery ); ?> nav span.TS_VGallery_nav-next{
            top : calc(calc(calc(100vh - var(--tsvg_popup_elem_height_<?php echo esc_attr( $Total_Soft_vgallery ); ?>)) / 2) + 
            calc(var(--tsvg_popup_elem_height_<?php echo esc_attr( $Total_Soft_vgallery ); ?>) ) + 
            var(--tsvg_header_cl_i_s_<?php echo esc_attr( $Total_Soft_vgallery ); ?>) );
  	    }
    }
    ...
    .TS_VGallery_icon<?php echo esc_attr( $Total_Soft_vgallery ); ?> i{
        cursor:pointer;
    }
    ...
    @media only screen and (max-height: 550px) {
        .TS_VGallery_item_block__<?php echo esc_attr( $Total_Soft_vgallery ); ?>{
