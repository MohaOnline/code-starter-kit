...
= 1.47.5 (November 13, 2023) =

- Fix: resolve issues with displayed ads on the group page
- Fix: prevent a fatal error on the placement page when there are placements without a type
