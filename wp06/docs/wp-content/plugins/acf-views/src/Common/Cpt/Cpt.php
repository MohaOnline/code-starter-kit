...
abstract class Cpt implements HooksInterface
{
    ...
    public function forceGutenbergEditorForDiviTheme($isEnabled): bool
    {
        if (!$this->isMyEditOrAddPostPage()) {
            return $isEnabled;
        }
    ...
    public function maybeShowErrorThatGutenbergEditorIsSuppressed(): void
    {
        ...
        printf(
            ...
            __(
                'ACF Views error: The Gutenberg editor is being suppressed. Please check your theme settings or installed plugins, which might be causing this issue. Alternatively, feel free to contact ACF Views support for further assistance.',
                'acf-views'
            )
        );
    }
    ...
    public function setHooks(bool $isAdmin): void
    {
        ...
        add_filter('et_builder_enable_classic_editor', [$this, 'forceGutenbergEditorForDiviTheme'], 99);
    }
}
