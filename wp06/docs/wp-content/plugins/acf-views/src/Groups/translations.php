...
__("Rules for the meta query. Multiple rules are supported. <a target='_blank' href='https://docs.acfviews.com/guides/acf-cards/features/meta-filter-pro'>Read more</a> <br>If you want to see the query that was created by your input, update the Card and reload the page. After have a look at the 'Query Preview' field in the 'Advanced' tab", "acf-views");
...
__("Rules for the taxonomy query. Multiple rules are supported. <a target='_blank' href='https://docs.acfviews.com/guides/acf-cards/features/taxonomy-filter-pro'>Read more</a> <br> If you want to see the query that was created by your input, update the Card and reload the page. After have a look at the 'Query Preview' field in the 'Advanced' tab", "acf-views");
...
__("Define your CSS style rules here or within your theme. Rules defined here will be added within &lt;style&gt;&lt;/style&gt; tags ONLY to pages that have this view. <br> Press Ctrl (Cmd) + Alt + L to format the code. <br> Magic shortcuts are available (and will use the BEM Unique Name if defined) : <br> '#view' will be replaced with '.acf-view--id--X' (or '.bem-name'). <br> '#view__' will be replaced with '.acf-view--id--X .acf-view__' (or '.bem-name .bem-name__'). It means you can use '#view__row' and it'll be replaced with '.bem-name .bem-name__row'. <br> '#__' will be replaced with '.acf-view__' (or '.bem-name__')", "acf-views");
__("Add your own Javascript to your view. This will be added within &lt;script&gt;&lt;/script&gt; tags ONLY to pages that have this view and also will be wrapped into an anonymous function to avoid name conflicts. <br> Press Ctrl (Cmd) + Alt + L to format the code. <br> Don't use inline comments ('//') inside the code, otherwise it'll break the snippet.", "acf-views");
