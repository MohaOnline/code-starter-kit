...
class Twig
{
    ...
    {
        return sprintf(
            '<p style="color:red;" class="acf-views__error">ACF Views (%s) template: <span class="acf-views__error-message">%s</span></p>',
    ...
    public function createTemplatesDir(): void
    {
        ...
        file_put_contents(
            ...
            'This directory is used by the ACF Views plugin to temporarily store Twig templates during execution.'
        );
    ...
    public function showTemplatesDirIsNotWritableWarning(): void
    {
        ...
        $message .= __(
            'Check and fix file permissions, then deactivate and activate back the ACF Views plugin. If the issue persists, contact support.',
            'acf-views'
        );
