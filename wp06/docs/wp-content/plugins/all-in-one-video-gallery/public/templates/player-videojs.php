...
if ( isset( $player_settings['playsinline'] ) && ! empty( $player_settings['playsinline'] ) ) {
...
<body id="body" class="aiovg-player vjs-waiting">
	...
	<?php if ( isset( $sources['vimeo'] ) ) : ?>
		<script src="<?php echo AIOVG_PLUGIN_URL; ?>vendor/videojs/plugins/vimeo/videojs-vimeo2.min.js?v=2.0.0" type="text/javascript"></script>
	<?php endif; ?>

	<?php if ( isset( $sources['dailymotion'] ) ) : ?>
		<script src="<?php echo AIOVG_PLUGIN_URL; ?>vendor/videojs/plugins/dailymotion/videojs-dailymotion.min.js?v=2.0.0" type="text/javascript"></script>
	<?php endif; ?>
	...
	<?php if ( ! empty( $settings['hotkeys'] ) ) : ?>
		<script src="<?php echo AIOVG_PLUGIN_URL; ?>vendor/videojs/plugins/hotkeys/videojs.hotkeys.min.js?v=0.2.28" type="text/javascript"></script>
	<?php endif; ?> 
