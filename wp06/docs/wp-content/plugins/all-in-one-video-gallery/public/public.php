...
class AIOVG_Public {
	...
	public function register_scripts() {
		...
		$scroll_to_top_offset = (int) apply_filters( 'aiovg_scroll_to_top_offset', 20 );
		if ( is_admin_bar_showing() ) {
			$scroll_to_top_offset += 32;
		}
	...
	/**
     * Indicate that a script should be treated as a module or importmap by adding 
	 * the correct type attribute to the script tag that WordPress will output.
     *
     * @since  3.5.0
