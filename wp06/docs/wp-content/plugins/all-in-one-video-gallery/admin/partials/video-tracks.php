...
<table id="aiovg-tracks" class="aiovg-table striped widefat">
	<tr class="aiovg-hidden-xs">
  		<th style="width: 5%;"></th>
    	<th><?php esc_html_e( 'File URL', 'all-in-one-video-gallery' ); ?></th>
    	<th style="width: 10%;"><?php esc_html_e( 'Label', 'all-in-one-video-gallery' ); ?></th>
  	...
  	<?php foreach ( $tracks as $key => $track ) : ?>
        <tr class="aiovg-tracks-row">
            ...
            <td>
                <button type="button" class="aiovg-upload-track button button-small"><?php esc_html_e( 'Upload File', 'all-in-one-video-gallery' ); ?></button>
                <button type="button" class="aiovg-delete-track button button-small"><?php esc_html_e( 'Delete', 'all-in-one-video-gallery' ); ?></button>
            </td>
        </tr>
  	<?php endforeach; ?>
</table>
...
<p>
	<button type="button" id="aiovg-add-new-track" class="button"><?php esc_html_e( 'Add New File', 'all-in-one-video-gallery' ); ?></button>
</p>
