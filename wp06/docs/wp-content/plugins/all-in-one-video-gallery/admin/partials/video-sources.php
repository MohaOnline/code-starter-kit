...
<table class="aiovg-table widefat">
  	<tbody>
    	<tr>
      		<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'Source Type', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>        
    	...
    	<tr id="aiovg-field-mp4" class="aiovg-toggle-fields aiovg-type-default">
      		<th scope="row" class="aiovg-hidden-xs">
        		<p><?php esc_html_e( 'Video File', 'all-in-one-video-gallery' ); ?></p>
				<div class="aiovg-text-small">(mp4, webm, ogv, m4v, mov)</div>
      		</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
					<strong><?php esc_html_e( 'Video File', 'all-in-one-video-gallery' ); ?></strong> <span class="aiovg-text-small">(mp4, webm, ogv, m4v, mov)</span>
				</p>
				...
				<div class="aiovg-input-wrap aiovg-media-uploader">
					...
					if ( ! empty( $quality_levels ) ) {
						...
						printf( 
							'<p><span class="dashicons dashicons-arrow-right"></span> %s (%s)</p>',
				...
				<?php if ( ! empty( $sources ) ) : 
					foreach ( $sources as $index => $source ) :	?>
						<div class="aiovg-input-wrap aiovg-media-uploader aiovg-source">
							...
							printf( 
								'<p><span class="dashicons dashicons-arrow-right"></span> %s</p>',
								esc_html__( 'Select a Quality Level', 'all-in-one-video-gallery' )
							);
		...
		<?php if ( ! empty( $webm ) ) : ?>
			<tr id="aiovg-field-webm" class="aiovg-toggle-fields aiovg-type-default">
				<th scope="row" class="aiovg-hidden-xs">
					<p><?php esc_html_e( 'WebM', 'all-in-one-video-gallery' ); ?></p>
					<div class="aiovg-text-small aiovg-text-error">(<?php esc_html_e( 'deprecated', 'all-in-one-video-gallery' ); ?>)</div>
				</th>
				<td>
					<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
		...
		<?php if ( ! empty( $ogv ) ) : ?>
			<tr id="aiovg-field-ogv" class="aiovg-toggle-fields aiovg-type-default">
				<th scope="row" class="aiovg-hidden-xs">
					<p><?php esc_html_e( 'OGV', 'all-in-one-video-gallery' ); ?></p>
					<div class="aiovg-text-small aiovg-text-error">(<?php esc_html_e( 'deprecated', 'all-in-one-video-gallery' ); ?>)</div>
				</th>
				<td>
					<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
		...
		<tr class="aiovg-toggle-fields aiovg-type-adaptive">
			<th scope="row" class="aiovg-hidden-xs">
				<?php esc_html_e( 'HLS URL', 'all-in-one-video-gallery' ); ?>
			</th>
			<td>
				<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
					<strong><?php esc_html_e( 'HLS URL', 'all-in-one-video-gallery' ); ?></strong>
				</p>
		...
		<tr class="aiovg-toggle-fields aiovg-type-adaptive">
			<th scope="row" class="aiovg-hidden-xs">
				<?php esc_html_e( 'MPEG-DASH URL', 'all-in-one-video-gallery' ); ?>
			</th>
			<td>
				<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
					<strong><?php esc_html_e( 'MPEG-DASH URL', 'all-in-one-video-gallery' ); ?></strong>
				</p>
    	...
    	<tr class="aiovg-toggle-fields aiovg-type-youtube">
			<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'YouTube URL', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
        ...
        <tr class="aiovg-toggle-fields aiovg-type-dailymotion">
      		<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'Dailymotion URL', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
		...
		<tr class="aiovg-toggle-fields aiovg-type-rumble">
      		<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'Rumble URL', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
        ...
        <tr class="aiovg-toggle-fields aiovg-type-facebook">
      		<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'Facebook URL', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
        ...
        <tr class="aiovg-toggle-fields aiovg-type-embedcode">
            <th scope="row" class="aiovg-hidden-xs">
                <?php esc_html_e( 'Embed Code', 'all-in-one-video-gallery' ); ?>
			</th>
            <td>
                <p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
    	...
    	<tr>
      		<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'Video Duration', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
    	...
    	<tr>
      		<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'Views Count', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
		...
		<tr id="aiovg-field-download" class="aiovg-toggle-fields aiovg-type-default">
      		<th scope="row" class="aiovg-hidden-xs">
        		<?php esc_html_e( 'Download', 'all-in-one-video-gallery' ); ?>
			</th>
      		<td>
        		<p class="aiovg-hidden-sm aiovg-hidden-md aiovg-hidden-lg">
