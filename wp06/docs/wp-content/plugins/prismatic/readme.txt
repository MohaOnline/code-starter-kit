=== Prismatic Ð Beautiful Syntax Highlight for Code Snippets ===
...
Highlight.js version used in Prismatic plugin: __11.7.0__
...
__Supported Languages__
	...
	PHP            = php
	PHP Template   = ([not documented](https://github.com/highlightjs/highlight.js/blob/main/SUPPORTED_LANGUAGES.md))
	Perl           = perl, pl, pm
	...
	VHDL           = vhdl
	Vim Script     = vim
	WebAssembly    = ([not documented](https://github.com/highlightjs/highlight.js/blob/main/SUPPORTED_LANGUAGES.md))
	YAML           = yaml
...
* Improves `plugin_links` function
* Updates Highlight.js to version 11.7.0
* Adds Highlight.js languages: GraphQL, PHP Template, WebAssembly
